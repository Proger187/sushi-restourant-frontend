...
export default function AdminLayout({
  ...
  return (
    <div className="flex min-h-screen bg-background">
      ...
      <aside
        className={clsx(
          "fixed lg:static inset-y-0 left-0 z-50 w-64 bg-surface border-r border-border flex flex-col transition-transform lg:translate-x-0",
      ...
      >
        ...
        <div className="p-3 border-t border-border">
          <button
            ...
            className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm text-muted hover:text-red-400 hover:bg-background w-full transition-colors"
          >
